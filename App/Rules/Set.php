...
class Set
{
    ...
    {
       //ss echo "<pre>"; print_r($rule); echo "</pre>";
       // echo "<pre>"; print_r($operator); echo "</pre>";
       // echo "<pre>"; print_r($ranges); echo "</pre>";
        ...
        if(is_object($selected_bundle_range) && isset($selected_bundle_range->recursive) &&  isset($selected_bundle_range->from) && $selected_bundle_range->recursive == 1){
            ...
            $value = isset($selected_bundle_range->value) ? intval($selected_bundle_range->value) : 0;
            ...
            if(isset($selected_bundle_range->type) && $selected_bundle_range->type == 'fixed_set_price'){
                $selected_bundle_range->value = $recursive_count * $value;
            }
        }
